<nav class="navbar navbar-expand-lg sticky bg-body-tertiary" data-bs-theme="dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="../Admin/AdminDashboard.php">The Skin Savvy</a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav  me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="../Admin/AdminDashboard.php">Home</a>
        </li>
        <li class="nav-item">
        ...
        <?php echo($_SESSION['admin_username']) ?>
         <?php }?>
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="../backend/adminlogout.php">Logout</a></li>
          </ul>
        </li>
