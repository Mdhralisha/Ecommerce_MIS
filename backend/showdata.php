...
$cosmetic_query = "SELECT count(product_id) as total_cosmetics FROM product_details where category='cosmetic'";
$skin_query = "SELECT count(product_id) as total_skin FROM product_details where category='skinCare'";
